          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article article-style-c">
                  <div class="article-header">
                    <div class="article-image" data-background="stisla/assets/img/kimiga_kureta.jpg">
                  ...
                  <div class="article-details">
                    ...
                    <div class="article-user">
                      <img alt="image" src="stisla/assets/img/avatar/avatar-2.png">
             ...
             <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article article-style-c">
                  <div class="article-header">
                    <div class="article-image" data-background="stisla/assets/img/lemon_raon_lee.jpg">
                      <div class="article-title">
                        <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                      </div>
                    </div>
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article article-style-c">
                  <div class="article-header">
                    <div class="article-image" data-background="stisla/assets/img/lemon.jpg">
                      <div class="article-title">
                        <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                      </div>
                    </div>
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article article-style-c">
                  <div class="article-header">
                    <div class="article-image" data-background="stisla/assets/img/hanabi.jpg">
                      <div class="article-title">
                        <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                      </div>
                    </div>
            ...
            <h2 class="section-title">Sering Diputar</h2>
            <p class="section-lead">This article component is based on card and flexbox.</p>
            ...
            <h2 class="section-title">Berdasarkan Kategori</h2>
            <p class="section-lead">This article component is based on card and flexbox.</p>
            ...
            <h2 class="section-title">Terakhir Diputar</h2>
            <div class="row">
              ...
              <div class="col-12 col-md-4 col-lg-4">
                <article class="article article-style-c">
                  ...
                  <div class="article-details">
                    ...
                    cillum dolore eu fugiat nulla pariatur. </p>
                    <div class="article-user">
                      <img alt="image" src="stisla/assets/img/avatar/avatar-3.png">
                      <div class="article-user-details">
                        <div class="user-detail-name">
